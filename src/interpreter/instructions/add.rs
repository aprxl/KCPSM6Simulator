...
pub fn register_register(
    ...
    let result = first_register.wrapping_add(second_register);

    update.carry = first_register as u32 + second_register as u32 > 255;
...
pub fn register_constant(
    ...
    let result = first_register.wrapping_add(rhs as u8);

    update.carry = first_register as u32 + rhs > 255;
    update.zero = result == 0u8;
    update.registers[lhs as usize] = result;
